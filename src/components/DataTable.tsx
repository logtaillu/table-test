...
const defaultToolbar = ['undo', 'redo', 'globalRange', 'autoHeight', 'size', 'fontSize', 'fontFamily', 'fontColor', 'backgroundColor', 'alignLeft', 'alignCenter', 'alignRight', 'verticalAlign'];
